/* clarity-js v0.6.32: https://github.com/microsoft/clarity (License: MIT) */ ! function() {
    "use strict";
    var t = Object.freeze({
            __proto__: null,
            get track() {
    ...
    function z() {
        ...
        E = {
            gap: t - D
        }, za(25), E.gap < 3e5 ? C = T(z, I) : xr && (k("clarity", "suspend"), Gr(), ["mousemove", "touchstart"].forEach((function(t) {
    ...
    function W(t) {
        Cr() && i.lean && (i.lean = !1, X = {
            key: t
        }, ar(), i.upgrade && i.upgrade(t), za(3))
    }
    var P = Object.freeze({
            __proto__: null,
            get data() {
            ...
            for (var e = 0, n = t; e < n.length; e++) {
                ...
                if (i) {
                    var o = Se(i).metadata.size,
                        ...
                        c = null,
                        s = null;
                    if (u && u.length > 0) c = Math.floor(100 * u[0].inlineSize), s = Math.floor(100 * u[0].blockSize);
                    else {
                        var l = r.getBoundingClientRect();
                        c = Math.floor(100 * l.width), s = Math.floor(100 * l.height)
                    }
                    c !== o[0] && s !== o[1] && (o = [c, s], Dt.push({
                        id: i,
                        width: c,
                        height: s
                    }))
    ...
    function Ae(t, e) {
        !1 === Ie.has(t) && (Ie.set(t, e), (Re = null === Re && ze ? new IntersectionObserver(He, {
        ...
        if (t && t.offsetParent)
            do {
                var n = t.offsetParent,
                    a = null === n ? ye(t.ownerDocument) : null;
                e.x += t.offsetLeft, e.y += t.offsetTop, t = a || n
            } while (t);
        return e
    }
    var Ue = ["input", "textarea", "radio", "button", "canvas"],
        Be = [];
    ...
    function dn(t, e, n) {
        ...
        if (i)
            for (var u = 0; u < i.length; u++) {
                var s = i[u],
                    l = "clientX" in s ? Math.round(s.clientX + r.scrollLeft) : null,
    ...
    function Pn(t, e) {
        ...
        switch (t.nodeType) {
            ...
            case Node.DOCUMENT_FRAGMENT_NODE:
                var c = t;
                if (c.host)
                    if (ge(c), "function" === typeof c.constructor && c.constructor.toString().indexOf("[native code]") >= 0) {
                        Un(c);
    ...
    function Un(t) {
        Oe(t) || (! function(t) {
            try {
                var e = o("MutationObserver"),
                    n = e in window ? new window[e](br(aa)) : null;
                n && (n.observe(t, {
                    attributes: !0,
                    childList: !0,
                    characterData: !0,
    ...
    function Da(t) {
        return void 0 === t && (t = !1), Z(this, void 0, void 0, (function() {
            ...
            return K(this, (function(l) {
                switch (l.label) {
                    case 0:
                        return Oa = null, (e = !1 === i.lean && Ma > 0 && (Ma < 1048576 || fr.sequence > 0)) && _(1, 1), Ye(),
                            function() {
                                var t = [];
                                pa = [];
            ...
            try {
                if (null === Ja) {
                    for (var u = location.hostname ? location.hostname.split(".") : [], c = u.length - 1; c >= 0; c--)
                        if (Ja = ".".concat(u[c]).concat(Ja || ""), c < u.length - 1 && (document.cookie = "".concat(o).concat(";").concat("domain=").concat(Ja), sr(t) === e)) return;
                    Ja = ""
                }
            } catch (t) {
                Ja = ""
    ...
    function wr(t, e, n, a) {
        void 0 === a && (a = !1), n = br(n);
        try {
            t[o("addEventListener")](e, n, a), yr.push({
                event: e,
                target: t,
                listener: n,
                capture: a
    ...
    var Lr = Object.freeze({
        __proto__: null,
        start: function() {
            Ot(), Nt(), We(), Re = null, Ie = new WeakMap, Ce = {}, je = [], ze = !!window.IntersectionObserver, he(),
                function() {
        ...
        stop: function() {
            We(), Ie = null, Ce = {}, je = [], Re && (Re.disconnect(), Re = null), ze = !1, pe(),
                function() {
