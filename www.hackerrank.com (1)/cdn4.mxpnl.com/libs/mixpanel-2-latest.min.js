(function() {
    ...
    (function() {
        function Aa() {
            ...
            if (t.addEventListener) "complete" === t.readyState ? a() : t.addEventListener("DOMContentLoaded", a, F);
        ...
        function Ba() {
            w.init = function(a, b, d) {
                if (d) return w[d] || (w[d] = G[d] = T(a,
                    b, d), w[d].da()), w[d];
                d = w;
                if (G.mixpanel) d = G.mixpanel;
                else if (a) d = T(a, b, "mixpanel"), d.da(), G.mixpanel = d;
                w = d;
                1 === ca && (A.mixpanel = w);
                Ca()
            }
        ...
        function T(a, b, d) {
            ...
            J = J || n.c("debug");
            !c.g(f) && c.isArray(f) &&
                (n.ua.call(n.people, f.people), n.ua(f));
            return n
        }
            ...
            return function() {
                ...
                try {
                    var c = b.call(this, "token"),
                        ...
                        g =
                        b.call(this, "opt_out_tracking_persistence_type"),
        ...
        c.a = function(a, b, d) {
            if (!(a === q || a === k))
                ...
                for (var c = 0, f = a.length; c < f && !(c in a && b.call(d, a[c], c, a) === ka); c++);
            else
                for (c in a)
                    if (Y.call(a, c) && b.call(d, a[c], c, a) === ka) break
        };
        c.extend = function(a) {
                ...
                if ('"' === h)
                    for (; f();) {
                        ...
                        if ("\\" === h)
                            ...
                            } else if ("string" === typeof j[h]) d += j[h];
                        else break;
                        else d += h
                    }
                g("Bad string")
        ...
        c.cookie = {
            ...
            qd: function(a, b, c, n, f, g, e) {
                ...
                c && (j = new Date, j.setTime(j.getTime() + 1E3 * c), j =
                    "; expires=" + j.toGMTString());
        ...
        c.pc = function() {
            ...
            function b(b) {
                ...
                for (h = 0; h < b.length; h++)
                    if (d = b[h].replace(/^\s+/, "").replace(/\s+$/, ""), -1 < d.indexOf("#")) {
                        g = d.split("#");
                        d = g[0];
            ...
            var n = c.bind(function() {
                ...
                try {
                    var c =
                        ...
                        c = oa(c, d);
                    if (b = this.Sa(c))
                        for (var c = this.X(), n = 0; n < c.length; n++) {
                            var e = c[n];
        ...
        C.prototype.flush = function(a) {
            try {
                if (this.Ib) S.log("Flush: Request already in progress");
                else {
                    var a = a || {},
                    ...
                    if (1 > e.length) this.Y();
                        ...
                        var h = c.bind(function(e) {
                                ...
                                try {
                                    var g = F;
                                    if (a.Xb) this.W.hd(i);
                                    else if (c.e(e) && "timeout" === e.error && (new Date).getTime() - d >= b) this.j("Network timeout; retrying"), this.flush();
                                    else if (c.e(e) && e.L && (500 <= e.L.status || 429 === e.L.status || "timeout" === e.error)) {
                                        var h = 2 * this.ia,
        ...
        var ca, w, N = A.XMLHttpRequest && "withCredentials" in new XMLHttpRequest,
        ...
        e.prototype.R = function(a, b, d) {
            ...
            this.p = {};
            if (this.N = this.c("batch_requests"))
                if (!c.localStorage.la(l) || !N) this.N = F,
                    p.log("Turning off Mixpanel request-queueing; needs XHR and localStorage support");
                else if (this.yc(), ba && A.addEventListener) {
        ...
        e.prototype.k = function(a, b, d, e) {
            ...
            if (!N)
                if (e) b.callback = e;
                else if (j || this.c("test")) b.callback = "(function(){})";
            b.ip = this.c("ip") ? 1 : 0;
            b._ = (new Date).getTime().toString();
            g && (i = "data=" + encodeURIComponent(b.data), delete b.data);
            var a = a + ("?" + c.bc(b)),
                o = this;
            if ("img" in b) i = t.createElement("img"), i.src = a, t.body.appendChild(i);
            else if (h) {
                try {
                    f = ba(a, i)
                } catch (m) {
                            ...
                            if (e)
                                if (j) {
                                    ...
                                    try {
                                        ...
                                        if (o.l(b), d.xc) a = u.responseText;
                                        else return
                                    }
                                    e(a)
                                } else e(Number(u.responseText))
                        } else a =
                            u.timeout && !u.status && (new Date).getTime() - w >= u.timeout ? "timeout" : "Bad HTTP status: " + u.status + " " + u.statusText, o.l(a), e && (j ? e({
                                status: 0,
                                error: a,
                                L: u
                            }) : e(0))
        ...
        e.prototype.m = P(function(a, b, d, e) {
            ...
            if (c.g(a)) this.l("No event name provided to mixpanel.track");
                ...
                this.eb();
                b = c.extend({}, c.info.V(), this.persistence.V(), this.K,
                    b);
        ...
        e.prototype.Jc = P(function(a, b, c) {
            var e = this.s(a);
            if (e !== k) {
                var f = e.indexOf(b); - 1 < f && (e.splice(f, 1), this.o({
                    pd: e
                }));
                0 === e.length && this.$(a)
            }
        ...
        e.prototype.uc = function(a, b) {
            var c = this.cc(a, b),
                e = this.Ya[c];
            if (e === k || e.xa !== a || e.wa !== b) e = new s, e.R(this, a,
                b), this.Ya[c] = e;
            return e
        };
        ...
        e.prototype.Nb = function(a) {
            if (c.e(a)) c.extend(this.config, a), a.batch_size && c.a(this.p, function(a) {
                a.Jb()
            }), this.c("persistence_name") || (this.config.persistence_name = this.config.cookie_name), this.c("disable_persistence") || (this.config.disable_persistence =
        ...
        e.prototype.gc = function() {
            ...
            else if (!this.ja() && (this.c("opt_out_tracking_by_default") || c.cookie.get("mp_optout"))) c.cookie.remove("mp_optout"),
                this.Pa({
                    clear_persistence: this.c("opt_out_persistence_by_default")
                })
        };
        e.prototype.ba = function(a) {
            if (a && a.clear_persistence) a = l;
            else if (a && a.enable_persistence) a = F;
            else return;
        ...
        m.prototype.get_cross_subdomain =
            m.prototype.tc;
        ...
        (function() {
            ...
            c.g(w) ? p.F('"mixpanel" object not initialized. Ensure you are using the latest version of the Mixpanel JS Library along with the snippet we provide.') : w.__loaded || w.config && w.persistence ? p.F("The Mixpanel library has already been downloaded at least once. Ensure that the Mixpanel code snippet only appears once on the page (and is not double-loaded by a tag manager) in order to avoid errors.") : 1.1 > (w.__SV || 0) ?
                p.F("Version mismatch; please ensure you're using the latest version of the Mixpanel code snippet.") : (c.a(w._i, function(a) {
