...
YUI.add("yui-base", function(b) {
    ...
    i.trimLeft = n.trimLeft ? function(v) {
        return v.trimLeft();
    } : function(v) {
        return v.replace(/^\s+/, "");
    };
    i.trimRight = n.trimRight ? function(v) {
        return v.trimRight();
    } : function(v) {
        return v.replace(/\s+$/, "");
    };
    ...
    j.each = j.forEach = f._isNative(q.forEach) ? function(x, v, w) {
    ...
    j.indexOf = f._isNative(q.indexOf) ? function(x, v, w) {
    ...
    j.some = f._isNative(q.some) ? function(x, v, w) {
    ...
    var f = b.Lang,
        o = Object.prototype.hasOwnProperty,
        u, g = b.Object = f._isNative(Object.create) ? function(v) {
...
YUI.add("event-move", function(e) {
    var j = ((e.config.win && ("ontouchstart" in e.config.win)) && !(e.UA.chrome && e.UA.chrome < 6)) ? {
            start: "touchstart",
            move: "touchmove",
            end: "touchend"
        } : {
            ...
            if (O) {
                ...
                if (G === 0 || N === 0) {
                    ...
                    if (G > 0) {
                        ...
                        F._hme = M.on(j[h], e.bind(function() {
                            this._cancel(F);
                        }, this));
                    }
                    if (N > 0) {
                        F._hm = M.on(j[C], e.bind(function(Q) {
                            if (Math.abs(Q.pageX - K[0]) > N || Math.abs(Q.pageY - K[1]) > N) {
                                this._start(J, E, D, F);
                            }
                        }, this));
                    }
...
YUI.add("event-focus", function(f) {
    var d = f.Event,
        c = f.Lang,
        a = c.isString,
        e = f.Array.indexOf,
...
YUI.add("attribute-core", function(c) {
    c.State = function() {
        this.data = {};
    };
    c.State.prototype = {
...
YUI.add("attribute-events", function(e) {
    var f = e.EventTarget,
        d = "Change",
        a = "broadcast",
        c = "published";
...
YUI.add("attribute-extras", function(f) {
    var a = "broadcast",
        d = "published",
        e = "initValue",
        c = {
...
YUI.add("attribute-base", function(b) {
    var a = function() {
