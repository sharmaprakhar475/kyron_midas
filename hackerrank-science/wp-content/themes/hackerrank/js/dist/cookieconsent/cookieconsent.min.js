! function(u) {
    if (!u.hasInitialised) {
        var h = {
            ...
            traverseDOMPath: function(e, t) {
                return e && e.parentNode ? h.hasClass(e, t) ? e : this.traverseDOMPath(e.parentNode, t) : null
            }
        };
        u.status = {
            deny: "deny",
        ...
        var o, t, i, s = Object.keys(u.status).map(h.escapeRegExp);
        u.customStyles = {}, u.Popup = (o = {
            enabled: !0,
            container: null,
            cookie: {
            ...
            var t = this.options.window.replace("{{classes}}", function() {
                    ...
                    return e.static && i.push("cc-static"), i.push.apply(i, a.call(this)),
                        function(e) {
                            ...
                            return this.customStyleSelector = n ? i : null, n && function(e, t, i) {
                                ...
                                var n = {},
                                    ...
                                    s = t.button,
                                    r = t.highlight;
                                o && (o.text = o.text ? o.text : h.getContrast(o.background), o.link = o.link ? o.link : o.text, n[i + ".cc-window"] = ["color: " + o.text, "background-color: " + o.background], n[i + ".cc-revoke"] = ["color: " + o.text, "background-color: " + o.background], n[i + " .cc-link," + i + " .cc-link:active," + i + " .cc-link:visited"] = ["color: " + o.link], s && (s.text = s.text ? s.text : h.getContrast(s.background), s.border = s.border ? s.border : "transparent", n[i + " .cc-btn"] = ["color: " + s.text, "border-color: " + s.border, "background-color: " + s.background], s.padding && n[i + " .cc-btn"].push("padding: " + s.padding), "transparent" != s.background && (n[i + " .cc-btn:hover, " + i + " .cc-btn:focus"] = ["background-color: " + (s.hover || function(e) {
                                    return "000000" != (e = h.normaliseHex(e)) ? h.getLuminance(e) : "#222"
                                }(s.background))]), r ? (r.text = r.text ? r.text : h.getContrast(r.background), r.border = r.border ? r.border : "transparent", n[i + " .cc-highlight .cc-btn:first-child"] = ["color: " + r.text, "border-color: " + r.border, "background-color: " + r.background]) : n[i + " .cc-highlight .cc-btn:first-child"] = ["color: " + o.text]));
                                ...
                                var c = -1;
                                for (var l in n) n.hasOwnProperty(l) && a.sheet.insertRule(l + "{" + n[l].join(";") + "}", ++c)
                            }(t, e, "." + i), n
                    ...
                    i.showLink || (i.elements.link = "", i.elements.messagelink = i.elements.message), Object.keys(i.elements).forEach(function(e) {
                        t[e] = h.interpolateString(i.elements[e], function(e) {
                            var t = i.content[e];
                            return e && "string" == typeof t && t.length ? t : ""
                        })
                    });
                    var e = i.compliance[i.type];
                    e = e || i.compliance.info, t.compliance = h.interpolateString(e, function(e) {
                        return t[e]
                    });
                    var n = i.layouts[i.layout];
                    return n = n || i.layouts.basic, h.interpolateString(n, function(e) {
                        return t[e]
                    })
                }.call(this)),
                i = this.options.overrideHTML;
            if ("string" == typeof i && i.length && (t = i), this.options.static) {
                var n = c.call(this, '<div class="cc-grower">' + t + "</div>");
                n.style.display = "", this.element = n.firstChild, this.element.style.display = "none", h.addClass(this.element, "cc-invisible")
            } else this.element = c.call(this, t);
            (function() {
                ...
                "number" == typeof e && 0 <= e && (this.dismissTimeout = window.setTimeout(function() {
                    r(u.status.dismiss), a(!0)
                }, Math.floor(e)));
                var t = this.options.dismissOnScroll;
                if ("number" == typeof t && 0 <= t) {
                    var i = function(e) {
                        window.pageYOffset > Math.floor(t) && (r(u.status.dismiss), a(!0), window.removeEventListener("scroll", i), this.onWindowScroll = null)
                    };
                    this.options.enabled && (this.onWindowScroll = i, window.addEventListener("scroll", i))
                }
                var n = this.options.dismissOnWindowClick,
                    c = this.options.ignoreClicksFrom;
                if (n) {
                    var l = function(e) {
                        for (var t = !1, i = e.path.length, n = c.length, o = 0; o < i; o++)
                            if (!t)
                                for (var s = 0; s < n; s++) t = t || h.hasClass(e.path[o], c[s]);
                        t || (r(u.status.dismiss), a(!0), window.removeEventListener("click", l), this.onWindowClick = null)
                    }.bind(this);
                ...
                function() {
                    if ("info" != this.options.type && (this.options.revokable = !0), h.isMobile() && (this.options.animateRevokable = !1), this.options.revokable) {
                        ...
                        this.revokeBtn = c.call(this, t);
                        var n = this.revokeBtn;
                        if (this.options.animateRevokable) {
                            var i = h.throttle(function(e) {
                                var t = !1,
                                    i = window.innerHeight - 20;
                                h.hasClass(n, "cc-top") && e.clientY < 20 && (t = !0), h.hasClass(n, "cc-bottom") && e.clientY > i && (t = !0), t ? h.hasClass(n, "cc-active") || h.addClass(n, "cc-active") : h.hasClass(n, "cc-active") && h.removeClass(n, "cc-active")
                            }, 200);
                ...
                function(e) {
                    if (h.isPlainObject(e)) {
                        ...
                        if (i && !--i.references) {
                            ...
                            n && n.parentNode && n.parentNode.removeChild(n), u.customStyles[t] = null
                        }
                    }
            ...
            var e = this.element;
            if (u.hasTransition && e && (this.afterTransition && r.call(this, e), h.hasClass(e, "cc-invisible"))) {
            ...
            var e = this.element;
            u.hasTransition && e && (this.openingTimeout && (clearTimeout(this.openingTimeout), n.bind(this, e)), h.hasClass(e, "cc-invisible") || (this.options.static && (this.element.parentNode.style.maxHeight = ""), this.afterTransition = r.bind(this, e), e.addEventListener(u.transitionEnd, this.afterTransition), h.addClass(e, "cc-invisible")))
        }, e.prototype.isOpen = function() {
            return this.element && "" == this.element.style.display && (!u.hasTransition || !h.hasClass(this.element, "cc-invisible"))
            ...
            var t = this.options.cookie,
                i = h.getCookie(t.name),
                n = 0 <= Object.keys(u.status).indexOf(i);
            0 <= Object.keys(u.status).indexOf(e) ? (h.setCookie(t.name, e, t.expiryDays, t.domain, t.path, t.secure), this.options.onStatusChange.call(this, e, n)) : this.clearStatus()
            ...
            var i = t();
            return i.name && h.deepExtend(i, this.options.serviceDefinitions[i.name](i)), i
        }, p.prototype.locate = function(e, t) {
            var i = this.getNextService();
            i ? (this.callbackComplete = e, this.callbackError = t, this.runService(i, this.runNextServiceOnError.bind(this))) : t(new Error("No services to run"))
        }, p.prototype.setupUrl = function(n) {
        ...
        }, p.prototype.runService = function(i, n) {
            var o = this;
            i && i.url && i.callback && (i.isScript ? d : f)(this.setupUrl(i), function(e) {
        ...
        }, p.prototype.runServiceCallback = function(t, e, i) {
            var n = this,
                o = e.callback(function(e) {
                    o || n.onServiceResult.call(n, t, e)
                }, i);
            o && this.onServiceResult.call(this, t, o)
        }, p.prototype.onServiceResult = function(e, t) {
            t instanceof Error || t && t.error ? e.call(this, t, null) : e.call(this, null, t)
        }, p.prototype.runNextServiceOnError = function(e, t) {
            if (e) {
                this.logError(e);
                var i = this.getNextService();
                i ? this.runService(i, this.runNextServiceOnError.bind(this)) : this.completeService.call(this, this.callbackError, new Error("All services failed"))
            } else this.completeService.call(this, this.callbackComplete, t)
        }, p.prototype.getCurrentServiceOpts = function() {
            var e = this.options.services[this.currentServiceIndex];
            return "string" == typeof e ? {
                name: e
            } : "function" == typeof e ? e() : h.isPlainObject(e) ? e : {}
        }, p.prototype.completeService = function(e, t) {
            this.currentServiceIndex = -1, e && e(t)
        }, p.prototype.logError = function(e) {
            ...
            h.deepExtend(this.options = {}, i), h.isPlainObject(e) && h.deepExtend(this.options, e)
        ...
        }, m.prototype.applyLaw = function(e, t) {
            var i = this.get(t);
            return i.hasLaw || (e.enabled = !1, "function" == typeof e.onNoCookieLaw && e.onNoCookieLaw(t, i)), this.options.regionalLaw && (i.revokable && (e.revokable = !0), i.explicitAction && (e.dismissOnScroll = !1, e.dismissOnTimeout = !1)), e
        }, m), u.initialise = function(t, i, n) {
            var o = new u.Law(t.law);
            i = i || function() {}, n = n || function() {};
            var e = Object.keys(u.status),
                s = h.getCookie("cookieconsent_status");
            0 <= e.indexOf(s) ? i(new u.Popup(t)) : u.getCountryCode(t, function(e) {
                delete t.law, delete t.location, e.code && (t = o.applyLaw(t, e.code)), i(new u.Popup(t))
            }, function(e) {
                delete t.law, delete t.location, n(e, new u.Popup(t))
            })
        }, u.getCountryCode = function(e, t, i) {
            e.law && e.law.countryCode ? t({
                code: e.law.countryCode
            }) : e.location ? new u.Location(e.location).locate(function(e) {
                t(e || {})
            }, i) : t({})
        }, u.utils = h, u.hasInitialised = !0, window.cookieconsent = u
    }
    ...
    function c(e) {
        ...
        i.innerHTML = e;
        var o = i.children[0];
        return o.style.display = "none", h.hasClass(o, "cc-window") && u.hasTransition && h.addClass(o, "cc-invisible"), this.onButtonClick = function(e) {
            var t = h.traverseDOMPath(e.target, "cc-btn") || e.target;
            if (h.hasClass(t, "cc-btn")) {
                var i = t.className.match(new RegExp("\\bcc-(" + s.join("|") + ")\\b")),
                    n = i && i[1] || !1;
                n && (this.setStatus(n), this.close(!0))
            }
            h.hasClass(t, "cc-close") && (this.setStatus(u.status.dismiss), this.close(!0));
